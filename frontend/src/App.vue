...
<!-- <template lang="pug">
  div
    button.btn.btn-primary.btn-margin(v-if="!authenticated", @click="login()") Log In

    button.btn.btn-primary.btn-margin(v-if="!authenticated", @click="privateMessage()") Call Private

    button.btn.btn-primary.btn-margin(v-if="!authenticated", @click="logout()") Log Out
